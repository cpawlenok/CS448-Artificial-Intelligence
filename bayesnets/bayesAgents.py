...
def constructBayesNet(gameState):
    ...
    "*** YOUR CODE HERE ***"
    # I acknowledge that the work on this project is my own along with Anthony Deangelo
    # Christopher Pawlenok
    # I used https://www.w3schools.com/python/ to figure out python syntax
    # This project felt like a giant game of tracking down all these strange data types and constant print statements
    # to see what data I'm actually working with
...
def fillYCPT(bayesNet, gameState):
    ...
    # this entire problem was a test of my trial and error skills
